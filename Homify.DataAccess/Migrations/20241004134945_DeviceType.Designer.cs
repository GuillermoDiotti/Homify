...
namespace Homify.DataAccess.Migrations
{
    ...
    [Migration("20241004134945_DeviceType")]
            ...
            modelBuilder.Entity("Homify.DataAccess.Contexts.HomifyDbContext+RoleSystemPermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleSystemPermissionId = "2347207f-003a-4916-b8e4-c4339519ae4f",
                            PermissionId = "1",
                            RoleId = "AdminId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "76f816ed-76f9-4fa0-bbf1-505aeac5712d",
                            PermissionId = "2",
                            RoleId = "AdminId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "a07e069b-0cf6-4677-bcb3-06eb72468a5a",
                            PermissionId = "3",
                            RoleId = "AdminId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "c897d4d7-81e1-4a3f-b957-db408077a7f1",
                            PermissionId = "4",
                            RoleId = "AdminId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "68688c4a-66cb-4ab2-87f8-247633a60e3d",
                            PermissionId = "5",
                            RoleId = "AdminId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "57ea2fa8-dd2f-47db-9557-7baaa5285272",
                            PermissionId = "6",
                            RoleId = "CompanyOwnerId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "252f6387-0334-419e-9746-2630f494e48e",
                            PermissionId = "7",
                            RoleId = "CompanyOwnerId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "fa6dd452-e369-4344-9e09-b67d452ae563",
                            PermissionId = "8",
                            RoleId = "CompanyOwnerId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "b2e4e4fe-8098-48fd-8afa-c4e62a19830c",
                            PermissionId = "9",
                            RoleId = "HomeOwnerId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "980c097c-f124-489f-8e45-ae4086c4a7e3",
                            PermissionId = "10",
                            RoleId = "HomeOwnerId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "925b9f11-d3cd-40c3-8551-2f79ffa6d414",
                            PermissionId = "11",
                            RoleId = "HomeOwnerId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "bbc69768-b52b-4e07-9dd9-8b17302dbbf2",
                            PermissionId = "12",
                            RoleId = "HomeOwnerId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "3454ac5f-5199-4f86-b4ab-4af92e64bb1d",
                            PermissionId = "13",
                            RoleId = "HomeOwnerId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "c59bcc88-609a-4e0c-b18d-75d55a2a08bb",
                            PermissionId = "14",
                            RoleId = "HomeOwnerId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "24291b09-1f60-46ed-aa1b-e8c285563374",
                            PermissionId = "15",
                            RoleId = "HomeOwnerId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "3dc8dc23-e298-409a-99aa-0bdc9d7e12a1",
                            PermissionId = "16",
                            RoleId = "HomeOwnerId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "afb05781-c371-4011-b73c-6584befb1632",
                            PermissionId = "17",
                            RoleId = "HomeOwnerId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "dd54b437-84e9-4312-8d0d-83bf06025207",
                            PermissionId = "18",
                            RoleId = "HomeOwnerId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "78515c4f-76a7-4c1b-b091-8a7da3ff30da",
                            PermissionId = "19",
                            RoleId = "HomeOwnerId"
                        });
                });
            ...
            modelBuilder.Entity("Homify.BusinessLogic.Admins.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "SeedAdminId",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 10, 4, 13, 49, 44, 453, DateTimeKind.Unspecified).AddTicks(2095), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("Homify.BusinessLogic.CompanyOwners.CompanyOwner", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 10, 4, 13, 49, 44, 453, DateTimeKind.Unspecified).AddTicks(2112), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("Homify.BusinessLogic.HomeOwners.HomeOwner", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "SeedHomeOwnerId",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 10, 4, 13, 49, 44, 453, DateTimeKind.Unspecified).AddTicks(2105), new TimeSpan(0, 0, 0, 0, 0)),
