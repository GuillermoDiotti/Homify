...
namespace Homify.DataAccess.Migrations
{
    ...
    [Migration("20241004143711_NotificationHomeUserId")]
    partial class NotificationHomeUserId
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Homify.DataAccess.Contexts.HomifyDbContext+RoleSystemPermission", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleSystemPermissionId = "0526b78f-ad8d-443d-9407-d9bb37638308",
                            PermissionId = "1",
                            RoleId = "AdminId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "62ba4927-c78b-441c-9693-a1059434433d",
                            PermissionId = "2",
                            RoleId = "AdminId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "246bb5c0-8ec7-4c2d-b874-261241fe2f79",
                            PermissionId = "3",
                            RoleId = "AdminId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "f0f3143d-baaa-4c46-9492-c0090537ee34",
                            PermissionId = "4",
                            RoleId = "AdminId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "469627d2-6a73-485e-881a-f43f25fa1a93",
                            PermissionId = "5",
                            RoleId = "AdminId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "e7596eec-daa7-4b31-8ea4-8f37c119c3bd",
                            PermissionId = "6",
                            RoleId = "CompanyOwnerId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "6f4d13cd-d21a-46d7-80a6-77f0977eb6eb",
                            PermissionId = "7",
                            RoleId = "CompanyOwnerId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "ee7f22af-b2f4-4b13-81f8-7e42618fa02c",
                            PermissionId = "8",
                            RoleId = "CompanyOwnerId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "68e712e4-b1bf-4121-9ecc-e880616afba6",
                            PermissionId = "9",
                            RoleId = "HomeOwnerId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "fad1f97e-8ebe-4f11-a3db-d921bebec031",
                            PermissionId = "10",
                            RoleId = "HomeOwnerId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "5bdc7199-d500-4abb-8494-3f156d08f5b0",
                            PermissionId = "11",
                            RoleId = "HomeOwnerId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "3c35b3c1-4253-40f0-96c2-3d0ce0547258",
                            PermissionId = "12",
                            RoleId = "HomeOwnerId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "94363523-85bd-459e-b15a-6cc3658169de",
                            PermissionId = "13",
                            RoleId = "HomeOwnerId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "31bdf194-6731-4e17-b7ef-c279267e36b5",
                            PermissionId = "14",
                            RoleId = "HomeOwnerId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "ba559d7d-5ee4-4f31-be7f-c7ff11b64618",
                            PermissionId = "15",
                            RoleId = "HomeOwnerId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "7abee44d-8f9a-42f7-bfe1-2acfaec82cee",
                            PermissionId = "16",
                            RoleId = "HomeOwnerId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "5239e7a3-6b62-44ad-9251-a86f4ee50b6a",
                            PermissionId = "17",
                            RoleId = "HomeOwnerId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "3008b79d-8ee5-4916-a8b0-1c3da94ea8d2",
                            PermissionId = "18",
                            RoleId = "HomeOwnerId"
                        },
                        new
                        {
                            RoleSystemPermissionId = "1ceefa7d-893a-4eda-8715-fd60495f4282",
                            PermissionId = "19",
                            RoleId = "HomeOwnerId"
                        });
                });
            ...
            modelBuilder.Entity("Homify.BusinessLogic.Admins.Entities.Admin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "SeedAdminId",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 10, 4, 14, 37, 10, 817, DateTimeKind.Unspecified).AddTicks(6149), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("Homify.BusinessLogic.CompanyOwners.CompanyOwner", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 10, 4, 14, 37, 10, 817, DateTimeKind.Unspecified).AddTicks(6167), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("Homify.BusinessLogic.HomeOwners.HomeOwner", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "SeedHomeOwnerId",
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 10, 4, 14, 37, 10, 817, DateTimeKind.Unspecified).AddTicks(6158), new TimeSpan(0, 0, 0, 0, 0)),
