...
namespace Homify.DataAccess.Migrations
{
    ...
    [Migration("20240928205701_Migration2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Homify.DataAccess.Repositories.Roles.Role", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Homify.BusinessLogic.SystemPermissions.SystemPermission", b =>
                {
                    b.HasOne("Homify.DataAccess.Repositories.Roles.Role", null)
                        .WithMany("Permissions")
            ...
            modelBuilder.Entity("Homify.BusinessLogic.Users.Entities.User", b =>
                {
                    b.HasOne("Homify.DataAccess.Repositories.Roles.Role", "Role")
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
